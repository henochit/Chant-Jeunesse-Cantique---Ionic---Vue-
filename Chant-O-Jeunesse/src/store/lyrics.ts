...
export const lyrics = [
  {
    id: 1,
    title: `Lorsqu’on est jeune, on danse et l’on rit`,
    refrain: `Chante O ! Jeunesse to Dieu ton Roi
        C’est lui qui nous mène au but à coup sur
        A lui la flamme de notre foi
        Nos cœurs qu’il veut rendre purs.`,
    paragraphs: [
      `Lorsqu’on est jeune, on danse et l’on rit
            On rêve de grands espoirs,
            On aime, on chante, tout nous sourit.
            Mais il nous faut faire un choix.`,
      `Vous les amis, quel sens a pour vous
            La vie et ses durs combats ?
            En Christ on trouve le ciel de tout
            Sa grâce affermit nos pas.`,
      `Vous les amis pour qui cette peur ?
            Quand passe soudain la mort,
            Christ est vivant  c’est le grand vainqueur
            Il veut rendre libre et fort.`,
      `Vous les amis comment donc bâtir
            Un monde qui soit meilleur
            Il est le chef qu’il nous faut servir
